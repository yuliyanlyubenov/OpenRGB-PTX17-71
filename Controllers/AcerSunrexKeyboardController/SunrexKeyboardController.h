...
#define SUNREX_KEYBOARD_MODE_WAVES          0x08
#define SUNREX_KEYBOARD_MODE_RIPPLE         0x06
#define SUNREX_KEYBOARD_MODE_FIREBALL       0x04
#define SUNREX_KEYBOARD_MODE_HEARTBEAT      0x07
#define SUNREX_KEYBOARD_MODE_BREATHING      0x03
